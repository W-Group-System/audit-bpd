                                        ...
                                        <tbody>
                                            ...
                                            <tr
                                                ...
                                                <td class="content-block"
                                                    ...
                                                    <p>Good day</p>
                                                    <p style="text-indent: 2em; line-height:20px; text-align:justify; text-justify:inter-word;"><p>A new Opportunity for Improvement (OFI) has been issued to you.</p>
                                                    <p style="text-indent: 2em; line-height:20px; text-align:justify; text-justify:inter-word;">Should you need clarification regarding the OFI, you may coordinate directly with the auditor or our office.</p>
                                            ...
                                            <tr
                                                ...
                                                <td class="content-block" itemprop="handler" itemscope=""
                                                    ...
                                                    <p><b>OFI # :</b> {{ $ofi->ofi_no }}</p> 
                                                    <p><b>Description :</b> {{ $ofi->description }}</p>
                                                    <p><b>Recommendation :</b> {{ $ofi->recommendation }}</p>
                                                    <hr>
                                                </td>
                                            </tr>
                                            <tr
